...
export class NurseryComponent implements OnInit {
  ...
  constructor(private manageFarmerRecordService : ManageFarmerRecordService,private verifyFarmerRecordsService: VerifyFarmerRecordService,private nurserySurveyData : NurserySurveyDataService) {
   }
